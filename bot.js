...
const {Message, StringSession, Image, Video} = require('./𝗶𝗻𝗿𝗹𝗯𝗼𝘁/');
...
${chalk.blue.italic('ℹ️ Connecting to WhatsApp...')}`);
    ...
    conn.on('open', async () => {
        ...
        console.log(
            chalk.green.bold('✅️𝗶𝗻𝗿𝗹𝗯𝗼𝘁 working ' + config.WORKTYPE + ' 𝚗𝚘𝚠 '));
          // thanks to afnanplk
...
*/
                        try {
                            ...
                            if (config.NOLOG == 'off') {
                                ...
                                await conn.sendMessage(conn.user.jid, '*~_________~ ༄ɪɴʀʟ ʙᴏᴛ࿐ ~______~*' +
